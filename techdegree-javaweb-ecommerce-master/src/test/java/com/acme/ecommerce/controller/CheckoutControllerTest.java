...
public class CheckoutControllerTest {
	...
	@Test
	public void postCouponCodeShorterThan5Test() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.post("/checkout/coupon").param("code", "abc")).andDo(print())
				.andExpect(status().is3xxRedirection())
				.andExpect(flash().attributeExists("org.springframework.validation.BindingResult.couponCode"))
				.andExpect(redirectedUrl("coupon"));
	}

	@Test
	public void postCouponWithLongerThan10Test() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.post("/checkout/coupon").param("code", "abc1234567")).andDo(print())
				.andExpect(status().is3xxRedirection())
				.andExpect(flash().attributeExists("org.springframework.validation.BindingResult.couponCode"))
				.andExpect(redirectedUrl("coupon"));
	}
